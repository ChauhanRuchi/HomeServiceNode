...
const { createSubService, getsubservice,getsubservicebyservice, createService,getservice,deleteService,deleteSubService,editService,editSubService} = require("../conteroller/service");
...
app.put("/HomeService/editservice/:_id",verfiytoken,upload.single("image"),editService)
app.put("/HomeService/editsubservice/:_id",verfiytoken,upload.single("image"),editSubService)
